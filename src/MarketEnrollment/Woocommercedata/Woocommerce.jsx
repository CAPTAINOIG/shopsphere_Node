          ...
          <div className='bg-white lg:w-[100%] w-[93%] md:w-[90%] lg:ms-0 md:ms-10 lg:h-[20%] ms-3 py-10 lg:mt-8 mt-0'>
            <div>
              ...
              <div className='flex px-5 lg:gap-28 md:gap-12'>
                ...
                <div>
                  <input {...register("enforcement")} type="checkbox" onChange={() => setEnforcement(!enforcement)} checked={enforcement} className="w-5 h-5 rounded-lg border border-gray-500 focus:outline-none appearance-none bg-white checked:bg-green-500 checked:border-green-500 relative checked:after:content-['✓'] checked:after:text-white checked:after:text-sm checked:after:font-bold checked:after:absolute checked:after:top-0 checked:after:left-1/2 checked:after:transform checked:after:-translate-x-1/2 checked:after:leading-5" />
                </div>
              </div>
              <div className='flex px-5 lg:gap-28 md:gap-12 my-5'>
                ...
                <input {...register("msrp")} type="checkbox" onChange={() => setMsrp(!msrp)} checked={msrp} className="w-5 h-5 rounded-lg border border-gray-500 focus:outline-none appearance-none bg-white checked:bg-green-500 checked:border-green-500 relative checked:after:content-['✓'] checked:after:text-white checked:after:text-sm checked:after:font-bold checked:after:absolute checked:after:top-0 checked:after:left-1/2 checked:after:transform checked:after:-translate-x-1/2 checked:after:leading-5" />
              </div>
              <div>
