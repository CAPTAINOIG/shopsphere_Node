...
const MyMarket = () => {
  ...
  const currentMarketplaces = filteredData.slice(indexOfFirstMarketplace, indexOfLastMarketplace);
    ...
    <div className="bg-white p-5 md:mt-20 mt-16 h-screen">
      ...
      {loader ? (
        ...
        <div className="py-5 mb-10 bg-white">
          ...
          {view === "edit" && (
            <div className="space-y-4">
              <UpdateMarket marketplaces={currentMarketplaces} searchTerm={searchTerm} />
            </div>
          )}
        </div>
      )}
