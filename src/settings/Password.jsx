...
const Password = () => {
  ...
  const handleChangePassword = async (data) => {
    ...
    try {
      ...
      if (error.response.status === 400 && error.response.data.error === "Invalid password"){
              ...
              >
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    >
                      {showOld ? <HiEyeOff size={18} /> : <BsEyeFill size={18} />}
                    </button>
                  </div>
                  {errors.password && (
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <button
                      ...
                      className="absolute right-2 top-2 text-gray-500"
                    >
                      {showNew ? <HiEyeOff size={18} /> : <BsEyeFill size={18} />}
                    </button>
                  </div>
                  {errors.new_password && (
                    <p className="text-red-500 text-sm mt-1">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <button
                      ...
                      className="absolute right-2 top-2 text-gray-500"
                    >
                      {showConfirm ? <HiEyeOff size={18} /> : <BsEyeFill size={18} />}
                    </button>
                  </div>
