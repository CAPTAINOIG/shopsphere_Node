  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      if ([200, 201, 202].includes(response.status)) {
        ...
        localStorage.setItem("Zanders", JSON.stringify(response.data));
        setMyLoader(false);
                        ...
                        {checkBoxesManufacturer.map((checkbox) => (
                          ...
                          >
                            ...
                            <input
                              ...
                              className="w-5 h-5 mb-1 rounded-lg border border-gray-500 focus:outline-none appearance-none bg-white checked:bg-green-500 checked:border-green-500 relative checked:after:content-['✓'] checked:after:text-white checked:after:text-sm checked:after:font-bold checked:after:absolute checked:after:top-0 checked:after:left-1/2 checked:after:transform checked:after:-translate-x-1/2 checked:after:leading-5"
                              onChange={() =>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <div className="flex items-center">
                      ...
                      <input
                        {...register("percentage_markup", { required: true })}
                        type="text"
                        placeholder="6"
                  ...
                  <div>
                    <div className="flex items-center">
                      ...
                      <input
                        {...register("fixed_markup", { required: true })}
                        type="text"
                        placeholder="8"
                        className="w-full border border-gray-500 rounded-md px-3 py-2 focus:outline-none focus:ring-1 focus:ring-green-500"
                        onInput={restrictToNumbersAndDecimals}
