    ...
    if (manufacturerChecked.length === 0) {
      ...
      try {
        ...
        if ([200, 201, 202].includes(response.status)) {
          ...
          localStorage.setItem("lipsey", response.data);
          setMyLoader(false);
                ...
                <div>
                  <div className="flex items-center">
                    <label className="block text-sm font-medium text-gray-700 mb-1 md:w-[70%] w-[80%]">
                      Percentage Markup <span className="text-red-600">*</span>
                    </label>
                    <input
                ...
                <div>
                  <div className="flex items-center">
                    <label className="block text-sm font-medium text-gray-700 mb-1 md:w-[50%] w-[80%]">
                      Fixed Markup <span className="text-red-600">*</span>
                    </label>
                    <input
