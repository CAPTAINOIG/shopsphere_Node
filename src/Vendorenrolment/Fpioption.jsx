          ...
          <form action="" className='lg:mx-20 mx-5' onSubmit={handleSubmit(onSubmit)}>
            ...
            <div>
              <div className='flex justify-between my-2'>
                ...
                <input {...register("file_urls" , {required : true})} type='' placeholder='Enter File Urls' className={`border border-black focus:outline-none py-1 rounded  h-[35px] w-[60%] p-3 lg:w-[50%] ${errors.file_urls?.message && 'error'}`} />
              </div>
            ...
            <div>
              <div className='flex justify-between my-2'>
                ...
                <input {...register("ftp_url" , {required : true})} type='' placeholder='Enter FTP Url' className={`border border-black focus:outline-none py-1 rounded  h-[35px] w-[60%] p-3 lg:w-[50%] ${errors.ftp_url?.message && 'error'}`} />
              </div>
