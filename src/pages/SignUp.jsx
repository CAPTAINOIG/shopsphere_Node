    ...
    <div>
      ...
      <section className="grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1">
        ...
        <div className="lg:py-20 py-0 flex flex-col  justify-center  lg:px-28 px-14 ">
          <h1 className="text-center font-bold text-2xl text-[#089451]">
            Create an Account
          </h1>
          <form action="" className="" onSubmit={formik.handleSubmit}>
            <p className="flex my-4 font-bold text-xl text-[#089451]">
              Sign Up
            </p>
            <div className=" h-[80px] my-3">
              ...
              <input
                type="text"
                placeholder="Jane"
                className="px-4 py-2 w-full border-[1.5px] mt-1 border-[#089451] focus:outline-[#089451]"
                name="first_name"
            ...
            <div className="h-[80px] relative my-3">
              ...
              <input
                ...
                placeholder=""
                autoComplete="off"
                className="border-[1.5px] mt-1 border-[#089451] py-2 px-4 w-full focus:outline-[#089451]"
                name="password"
                onBlur={formik.handleBlur}
                onChange={formik.handleChange}
              />
            ...
            <div className="h-[80px] relative my-3">
              ...
              <input
                ...
                placeholder=""
                className="border-[1.5px] bg-white border-[#089451] py-2 mt-1 px-4 w-full focus:outline-[#089451]"
                name="password2"
                onBlur={formik.handleBlur}
                onChange={formik.handleChange}
              />
            ...
            <button
              type="submit"
              className="w-full bg-[#089451] flex justify-center items-center h-[40px] rounded text-white font-bold py-3 mt-5 mb-10"
            >
              {myloader ? (
