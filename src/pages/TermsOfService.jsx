  ...
  return (
    <div className="md:px-10 py-5 bg-[#E7F2ED]">
      <section className="relative flex bg-white">
        ...
        <div className="flex-[3] bg-white absolute h-[50%]  right-0 border border-[#DBD9D9] shadow-[inset_2px_2px_6px_rgba(0,0,0,0.05),inset_-2px_-2px_6px_rgba(255,255,255,0.7)]">
