...
const getProductByName = (req, res) => {
  ...
  if (products.length === 0) {
    return res
      .status(400)
      .json({ status: false, message: "No products found in this category" });
  } else {
    return res.status(200).json({ status: true, products });
  }
};
...
const getProductByCategoryOrSection = (req, res) => {
  ...
  if (products.length === 0) {
    return res
      .status(404)
      .json({ message: "No products found in this category or section" });
  } else {
...
const getProductByPrice = (req, res) => {
  ...
  if (isNaN(priceValue)) {
    return res
      .status(400)
      .json({ status: false, message: "Invalid price value" });
  }
  ...
  if (products.length === 0) {
    return res
      .status(404)
      .json({ status: false, message: "No products found with this price" });
  } else {
    return res.status(200).json({ status: true, products });
  }
};
